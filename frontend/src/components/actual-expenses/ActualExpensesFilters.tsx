    ...
    <div className="flex flex-col gap-3 sm:flex-row sm:flex-wrap sm:items-end">
      ...
      <div className="flex flex-col gap-1">
        ...
        <input
          ...
          className="w-full rounded-lg border border-slate-200 bg-white px-3 py-1.5 text-sm text-slate-800 shadow-sm focus:border-brand-400 focus:outline-none focus:ring-1 focus:ring-brand-200 sm:w-auto sm:min-w-[180px]"
        />
      </div>
